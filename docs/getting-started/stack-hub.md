...
| PyroCMS      | PostgreSQL, PHP-FPM, NGINX  |  1 сервер, 3 контейнера | [GitHub](https://github.com/d2cio/pyrocms-stack) \| [Развернуть](https://panel.d2c.io/?import=https://github.com/d2cio/pyrocms-stack/archive/master.zip)
...
| MariaDB MasterSlave   | MariaDB, PHPMyAdmin (PHP-FPM), NGINX  |  2 сервера, 4 контейнера | [GitHub](https://github.com/d2cio/mariadb-masterslave-stack) \| [Развернуть](https://panel.d2c.io/?import=https://github.com/d2cio/mariadb-masterslave-stack/archive/master.zip)
...
| Percona MasterSlave  | Percona, PHPMyAdmin (PHP-FPM), NGINX  |  2 сервера, 4 контейнера | [GitHub](https://github.com/d2cio/percona-masterslave-stack) \| [Развернуть](https://panel.d2c.io/?import=https://github.com/d2cio/percona-masterslave-stack/archive/master.zip)
...
| MySQL MasterSlave    | MySQL, PHPMyAdmin (PHP-FPM), NGINX  |  2 сервера, 4 контейнера | [GitHub](https://github.com/d2cio/mysql-masterslave-stack) \| [Развернуть](https://panel.d2c.io/?import=https://github.com/d2cio/mysql-masterslave-stack/archive/master.zip)
